...
- Radar sits in the LED tower (forward view); the **camera looks forward** to the terrace from a small pod on the front-bottom edge (tilted ~12° down), not straight down.
