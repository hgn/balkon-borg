...
// arbiter is the only thing that talks to it (decision 2026-07-20: the ESP publishes
...
// the arbiter deals in submodes and percentages and never in preset numbers.
package main
